...
const TataNeuCardDesign = ({ card }: { card: CreditCard }) => {
  const chipImage = PlaceHolderImages.find(img => img.id === 'credit-card-chip');

  return (
    <div className="aspect-[1.586] w-full rounded-xl p-6 flex flex-col justify-between text-white shadow-lg relative overflow-hidden bg-[#1A5B9A]">
      <div 
        className="absolute top-0 left-0 w-full h-full"
        style={{
          backgroundImage: 'linear-gradient(to bottom right, #0073C5 50%, #1A5B9A 50%)',
        }}
      />
        ...
        <div className="flex flex-col">
            <div className="flex items-center gap-1">
                <svg width="24" height="24" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M10 0L20 10V20H10L0 10V0H10Z" fill="white"/>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
                 <svg width="80" height="25" viewBox="0 0 100 30" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0" y="0" width="30" height="30" fill="none" stroke="white" strokeWidth="2"/>
                    <path d="M5 5 H25 V25 H5 Z" fill="white"/>
                    <path d="M10 10 H20 V20 H10 Z" fill="#1A5B9A"/>
                    <text x="35" y="21" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="bold" fill="white">HDFC BANK</text>
                </svg>
            </div>
            <div className="text-right">
                <div className="flex items-center gap-1">
                    <svg width="50" height="20" viewBox="0 0 60 20" xmlns="http://www.w3.org/2000/svg">
                        <text x="0" y="15" fontFamily="Arial, sans-serif" fontSize="16" fontWeight="bold" fill="white">RuPay</text>
                        <path d="M50 5 L55 10 L50 15 Z" fill="#FF7F00" />
                    </svg>
                    <span className="text-xs font-light">PLATINUM</span>
                </div>
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-start">
         <svg viewBox="0 0 130 30" className="w-24 h-auto">
            <rect width="130" height="30" fill="none"/>
